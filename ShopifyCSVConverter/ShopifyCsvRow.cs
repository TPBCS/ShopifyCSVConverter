...
namespace ShopifyCSVConverter
{
    ...
    public class ShopifyCsvRowMap : ClassMap<ShopifyCsvRow>
    {
        public ShopifyCsvRowMap()
        {
            ...
            this.Map(m => m.Option1Name ).Name("Option 1 Name").Index(7);
            this.Map(m => m.Option1Value ).Name("Option 1 Value").Index(8);
            this.Map(m => m.Option2Name ).Name("Option 2 Name").Index(9);
            this.Map(m => m.Option2Value ).Name("Option 2 Value").Index(10);
            this.Map(m => m.Option3Name ).Name("Option 3 Name").Index(11);
            this.Map(m => m.Option3Value ).Name("Option 3 Value").Index(12);
            ...
            this.Map(m => m.VariantInventoryQty ).Name("Variant Inventory Qty").Index(16);
            this.Map(m => m.VariantInventoryPolicy ).Name("Variant Inventory Policy").Index(17);
            this.Map(m => m.VariantFulfilmentService ).Name("Variant Fulfilment Service").Index(18);
            ...
            this.Map(m => m.VarianRequiresShipping ).Name("Varian Requires Shipping").Index(21);
            ...
            this.Map(m => m.GiftCard ).Name("GiftCard").Index(26);
